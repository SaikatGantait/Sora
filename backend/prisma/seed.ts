...
async function main() {
  ...
  await prisma.template.upsert({
    ...
    update: {
      ...
      layers: JSON.stringify([
        { type: 'video', src: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerEscapes.mp4', start: 0, end: 10 },
  ...
  await prisma.template.upsert({
    where: { id: 'startup_ad' },
    update: {
      name: 'Startup Ad', duration: 8,
      previewUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerBlazes.mp4',
      layers: JSON.stringify([
        { type: 'video', src: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerBlazes.mp4', start: 0, end: 8 },
  ...
  await prisma.template.upsert({
    ...
    update: {
      name: 'Fashion Promo', duration: 12,
      previewUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerFun.mp4',
      layers: JSON.stringify([
        { type: 'video', src: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerFun.mp4', start: 0, end: 12 },
  ...
  await prisma.template.upsert({
    where: { id: 'food_reel' },
    update: {
      name: 'Food Reel', duration: 9,
      previewUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerMeltdowns.mp4',
      layers: JSON.stringify([
        { type: 'video', src: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerMeltdowns.mp4', start: 0, end: 9 },
  ...
  await prisma.template.upsert({
    ...
    update: {
      name: 'Quote Motion', duration: 6,
      previewUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ElephantsDream.mp4',
      layers: JSON.stringify([
        { type: 'video', src: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ElephantsDream.mp4', start: 0, end: 6 },
  ...
  await prisma.template.upsert({
    ...
    update: {
      name: 'Real Estate Card', duration: 10,
      previewUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerJoyrides.mp4',
      layers: JSON.stringify([
        { type: 'video', src: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerJoyrides.mp4', start: 0, end: 10 },
  ...
  await prisma.template.upsert({
    ...
    update: {
      name: 'Fitness Motivation', duration: 8,
      previewUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4',
      layers: JSON.stringify([
        { type: 'video', src: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4', start: 0, end: 8 },
  ...
  await prisma.template.upsert({
    ...
    update: {
      name: 'Travel Vlog', duration: 12,
      previewUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerEscapes.mp4',
      layers: JSON.stringify([
        { type: 'video', src: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerEscapes.mp4', start: 0, end: 12 },
  ...
  await prisma.template.upsert({
    ...
    update: {
      name: 'Podcast Audiogram', duration: 9,
      previewUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/SubaruOutbackOnStreetAndDirt.mp4',
      layers: JSON.stringify([
        { type: 'video', src: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/SubaruOutbackOnStreetAndDirt.mp4', start: 0, end: 9 },
  ...
  await prisma.template.upsert({
    ...
    update: {
      name: 'Product Showcase', duration: 10,
      previewUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerFun.mp4',
      layers: JSON.stringify([
        { type: 'video', src: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerFun.mp4', start: 0, end: 10 },
